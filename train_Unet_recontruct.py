...
def parse_args(input_args=None):
    ...
    parser.add_argument("--output_dir",type=str,default="./results/VIFusion/multiFusion-0303a",)
...
def main(args):
    ...
    optimizer, train_dataloader, lr_scheduler,vae_fuse_net= accelerator.prepare(
        optimizer,train_dataloader,lr_scheduler,vae_fuse_net)
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    if global_step % args.validation_steps == 0:
                        ...
                        log_validation(logger, vae, unet, image_encoder, text_encoder,tokenizer,vae_fuse_net, args, accelerator, global_step)
                        vae_fuse_net.train()
