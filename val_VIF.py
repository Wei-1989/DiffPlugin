...
def log_validation(logger, vae, unet, image_encoder,  scb_net, img1_tpb_net,img2_tpb_net,feature_fusion_net,
    ...
    image_logs = validation(args, vae, unet, image_encoder,  scb_net, img1_tpb_net,img2_tpb_net,feature_fusion_net,task_prompt_fusion_net, noise_scheduler, args.validation_image, logger=logger)
...
def validation(args, vae, unet, image_encoder, scb_net, img1_tpb_net,img2_tpb_net,feature_fusion_net,task_prompt_fusion_net, noise_scheduler, validation_images, logger=None):
    ...
    for index, (img1,img2) in enumerate(zip(img1_image_path,img2_image_path)):
        ...
        with torch.no_grad():
            ...
            for _, t in enumerate(timesteps):
                ...
                down_block_res_samples = scb_net(latents, t, encoder_hidden_states=fusion_prompt_guidance, cond_img=fuse_scb_cond, return_dict=False,)
