...
from val_VIF_Text_test import log_validation
...
from modules import CustomEncoder,CustomDecoder,VAEFuseNet
...
def parse_args(input_args=None):
    ...
    parser.add_argument("--output_dir", type=str, default="./results/VIFusion/text_test-0315a", )
...
def main(args):
    ...
    optimizer, train_dataloader, lr_scheduler,vae_fuse_net= accelerator.prepare(optimizer,train_dataloader,lr_scheduler,vae_fuse_net)
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(vae_fuse_net):
                ...
                batch["text"]=["This is the fusion of infrared and visible light, aiming to generate images with clear textures and prominent "
                               "targets."]*bsz
                ...
                text_features=torch.zeros_like(text_features).to(accelerator.device)
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    if global_step % args.validation_steps == 0:
                        ...
                        log_validation(logger, vae, unet, clip_image_encoder,text_encoder,tokenizer,vae_fuse_net, args,
                                       accelerator,
                                       global_step)
