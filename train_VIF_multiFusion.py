...
from val_VIF_multiFusion import log_validation
...
def parse_args(input_args=None):
    ...
    parser.add_argument("--output_dir", type=str, default="./results/VIFusion/multiFusion-0316b", )
    parser.add_argument("--num_train_epochs", type=int, default=100)
    parser.add_argument("--checkpointing_steps", type=int, default=500,)
    parser.add_argument("--validation_steps", type=int, default=500, )
    parser.add_argument("--train_data_file_list", type=str, default='data/train/vi_fusion_DiS-IF.csv', )
...
def main(args):
    ...
    optimizer, train_dataloader, lr_scheduler, img1_tpb_net,img2_tpb_net,text2image_prompt_fusion_net,task_prompt_fusion_net,vae_fuse_net= accelerator.prepare(
        optimizer,train_dataloader,lr_scheduler, img1_tpb_net,img2_tpb_net,text2image_prompt_fusion_net,task_prompt_fusion_net,vae_fuse_net)
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    if global_step % args.checkpointing_steps==0 or global_step == 1:
                        manage_checkpoints(base_dir=args.output_dir, enhancement=args.checkpointing_steps, max_checkpoints=args.checkpoints_total_limit)
                    ...
                    if global_step % args.validation_steps == 0:
                        ...
                        log_validation(logger, vae, unet, image_encoder, text_encoder,tokenizer,vae_fuse_net, img1_tpb_net,img2_tpb_net,text2image_prompt_fusion_net,
