...
def parse_args(input_args=None):
    ...
    parser.add_argument("--ckpt_dir", type=str, default="results/VIFusion/WholeNetwork-CNN-Attention/pick-checkpoint-26600/", required=False,)
    ...
    parser.add_argument("--save_root", default="Test_Results/WholeNetwork-CNN-Attention/temp" )
    
    parser.add_argument("--seed", type=int, default=42,)
    parser.add_argument("--img_path", type=str, default="./data/val/vi_fusion/")
