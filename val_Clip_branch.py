...
def validation(args, vae, unet, clip_image_encoder, text_encoder, tokenizer, img1_tpb_net, img2_tpb_net, task_prompt_fusion_net,
    ...
    text_folder = os.path.join(validation_images, 'content_detail')
    # 获取文件夹中的所有文件
    img1_image_path = [
    ...
    # 只要特定文件-----------------
    target_filenames = {"00081D","00123D","00196D","01458D" }
