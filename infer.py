...
def parse_args(input_args=None):
    ...
    parser.add_argument("--ckpt_dir", type=str, default="pre-trained/lowlight/", required=False,)
    ...
    parser.add_argument("--img_path", type=str, default="./TestData/00022N.png")
...
if __name__ == "__main__":
    ...
    try:
        ...
        tpb_net.load_state_dict(torch.load(TPBNet_path,weights_only=True)['model'], strict=True)
    except:
