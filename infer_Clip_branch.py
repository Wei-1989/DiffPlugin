...
def parse_args(input_args=None):
    ...
    parser.add_argument("--ckpt_dir", type=str, default="results/VIFusion/Clip_branch_0318a/pick-checkpoint-13500/", required=False, )
    ...
    parser.add_argument("--save_root", default="Test_Results/Clip_branch/0318a")
...
if __name__ == "__main__":
    ...
    # 只要特定文件-----------------
    target_filenames = {"00123D","00196D","01458D" }
    ...
    with torch.no_grad():
        ...
        for index,(img1,img2,text) in enumerate(zip(img1_images,img2_images,text_list)):
            ...
            visualization_tensor(img1_prompt_guidance.permute(0,2,1).view(-1,16,16),batch_dim_exit=False)
            visualization_tensor(img2_prompt_guidance.permute(0,2,1).view(-1,16,16),batch_dim_exit=False)
            ...
            for i, t in enumerate(timesteps):
                ...
                #         if name in ['down_blocks.2.attentions.0.transformer_blocks.0.attn2',
