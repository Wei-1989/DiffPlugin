...
from modules import CustomEncoder,CustomDecoder,SCBNet
import json
...
def parse_args(input_args=None):
    ...
    parser.add_argument("--output_dir", type=str, default="./results/Stage_two/whole_network", )
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(feature_fusion_module) and accelerator.accumulate(vae_decoder):
                ...
                for i, t in enumerate(timesteps):
                    ...
                    # update the latents
                    latents = noise_scheduler.step(noise_pred, t, latents, return_dict=False)[0].detach()
