...
def parse_args(input_args=None):
    ...
    parser.add_argument("--ckpt_dir", type=str, default="results/VIFusion/SD/checkpoint-4000/", required=False, )
    ...
    parser.add_argument("--inp_of_unet_is_random_noise", action="store_true", default=False, help="only set this to True for lowlight and highlight "
                                                                                              "tasks")
