...
from val_VIF_single_inject import log_validation
...
def parse_args(input_args=None):
    ...
    parser.add_argument("--output_dir",type=str,default="./results/VIFusion/diff-plugin",)
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    if global_step % args.validation_steps == 0:
                        ...
                        log_validation(logger, vae, unet, image_encoder, scb_net, img1_tpb_net,img2_tpb_net,
