...
def parse_args(input_args=None):
    ...
    parser.add_argument("--output_dir",type=str,default="./results/lowlight/diff-plugin",)
    ...
    parser.add_argument("--train_data_file_list",type=str,default='data/train/lowlight.csv',)
    parser.add_argument("--validation_image",type=str,default="data/val/lowlight",help="List of validation image paths")
