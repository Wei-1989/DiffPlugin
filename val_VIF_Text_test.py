...
def log_validation(logger=None,
    ...
    vae_pretrained_path= "./results/Stage_two/whole_network/checkpoint-54000/"
...
def validation(args=None,
    ...
    for index, (img1, img2, text) in enumerate(zip(img1_image_path, img2_image_path, text_path)):
        ...
        with torch.no_grad():
            ...
            content = "This is the fusion of infrared and visible light, aiming to generate images with clear textures and prominent targets."
